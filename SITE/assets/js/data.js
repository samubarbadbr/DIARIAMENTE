...
export const HERO = {
  badge: "Registrazioni aperte per la Beta",
  title: "Ogni giorno lascia una traccia. Qui diventa leggibile.",
  lede:
    "Diariamente è un diario guidato per l'anima. Rispondi a poche domande, registra un pensiero a voce " +
    "e guarda come cambiano umore, energia e abitudini nel tempo. Unisciti a migliaia di utenti in attesa per iOS e Android.",
  primaryCta: "Iscriviti alla Waitlist",
...
export const TESTIMONIALS = [
  {
    name: "Elena Rossi",
    role: "Freelance",
    text: "Da quando uso Diariamente non ho più saltato un giorno. Le note vocali mi permettono di sfogarmi senza dover scrivere quando sono stanca.",
    avatar: "ER"
  },
  {
    name: "Marco B.",
    role: "Studente",
    text: "La heatmap mi motiva incredibilmente. Vedere la mappa dei miei progressi mi fa capire che sono più costante di quanto pensassi.",
    avatar: "MB"
  },
  {
    name: "Silvia Fabbri",
    role: "Designer",
    text: "L'interfaccia è un capolavoro. Minimalista, scura, con micro-interazioni che ti fanno venire voglia di aprirla ogni sera. La trascrizione IA è precisissima.",
    avatar: "SF"
  },
  {
    name: "Luca Moretti",
    role: "Sviluppatore",
    text: "La privacy era la mia preoccupazione principale per un'app del genere. Sapere che posso cancellare o esportare tutto mi dà totale sicurezza.",
    avatar: "LM"
  }
];
